...
#   user_data = templatefile("./scripts/ocapp-al2023.sh", { S3_BUCKET_NAME = aws_s3_bucket.credential-bucket.bucket })
...
#   user_data = templatefile("./scripts/ocdb-al2023.sh", { S3_BUCKET_NAME = aws_s3_bucket.credential-bucket.bucket })
